...
public class BMModelDespawnEvent extends BMTrackerScriptEvent {

    // <--[event]
    // @Events
    // bm model despawns for player
    //
    // @Group DBetterModel
    //
    ...
    // @Cancellable false
    //
    // @Triggers when a model becomes invisible to (despawns for) a player. Requires the SPAWN_EVENTS capability of the active compat layer.
    //
    // @Context
    // <context.model> returns the BMModelTag that despawned.
    ...
    // <context.player> returns the PlayerTag the model despawned for.
    //
    // @Player Always.
    //
    // -->

    public static BMModelDespawnEvent instance;

    public Player player;

    public BMModelDespawnEvent() {
        instance = this;
        registerCouldMatcher("bm model despawns for player");
    }
