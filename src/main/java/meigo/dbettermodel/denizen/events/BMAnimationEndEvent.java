...
public class BMAnimationEndEvent extends BMTrackerScriptEvent {
    ...
    // @Cancellable false
    //
    // @Triggers when an animation sequence stops playing on a model for a player.
    ...
    //
    // @Context
    // <context.model> returns the BMModelTag whose animation ended.
    ...
    // <context.player> returns the PlayerTag the animation played for.
    //
    // @Player Always.
    //
    // -->

    public static BMAnimationEndEvent instance;

    public Player player;
    public String animation;

    public BMAnimationEndEvent() {
        instance = this;
        registerCouldMatcher("bm animation ends");
