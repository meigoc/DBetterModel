...
public class BMModelDismountedEvent extends BMTrackerScriptEvent {
    ...
    // @Cancellable false
    //
    // @Triggers when an entity dismounts a model bone hitbox (seat). Requires the MOUNT_EVENTS capability of the active compat layer.
    //
    // @Context
    // <context.model> returns the dismounted BMModelTag.
    ...
    // <context.passenger> returns the EntityTag that dismounted.
    //
    // -->

    public static BMModelDismountedEvent instance;

    public BmBone bone;
    public Entity passenger;

    public BMModelDismountedEvent() {
        instance = this;
        registerCouldMatcher("bm model dismounted");
    }
