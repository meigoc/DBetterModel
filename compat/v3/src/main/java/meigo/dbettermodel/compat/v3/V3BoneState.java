...
final class V3BoneState {
    ...
    V3BoneState(RenderedBone bone) {
        this.item = bone.getGroup().getItemStack().copy();
        // 3.x renamed addRotationModifier -> addLocalRotModifier (matrix §5).
        bone.addLocalRotModifier(BonePredicate.TRUE, animationRotation ->
